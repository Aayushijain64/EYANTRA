...
def color_detect(img,ids):
    ...
    color = img[cy, cx]
    color1 = img[cy1, cx1]
    if (color[0] >=0 and color[0]<=10 and color[1] >= 80 and color[1] <= 150 and color[2] >= 200 and color[2] <= 255):
        img= cv2.drawContours(img,[contours[4]], 0, (0,255,0),25)
    elif (color[0] >=0 and color[0]<=10 and color[1] >= 0 and color[1] <= 10 and color[2] >= 250 and color[2] <= 255):
    ...
    with open('1294_Task1.2.csv', 'a') as f:
        writer = csv.writer(f)
